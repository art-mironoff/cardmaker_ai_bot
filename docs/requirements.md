...
### 3.4. Редактирование изображений
...
### 3.5. Несколько карточек и вариантов
...
Ссылки:
- :lock: Политика конфиденциальности
- :page_facing_up: Пользовательское соглашение
...
- Стоимость: **50 рублей** за 1 генерацию
- Перед генерацией проверяется баланс пользователя

### 6.2. Редактирование/доработка
...
### 6.3. Генерация нескольких карточек
...
> 📎 Прототип: ![Выбор суммы](prototipe/payment_select_amount.png) ![Ссылка на оплату](prototipe/payment_link.png) ![Страница ЮKassa](prototipe/payment_yookassa_page.png)

- Баланс пользователя в рублях
- Кнопка "Пополнить баланс" (механизм оплаты — уточнить)
- Стоимость генерации 1 карточки: **50 рублей**
...
- **Генерация изображений:** нейросеть (конкретная модель — уточнить)
- **Хранение данных:** баланс пользователей, история генераций
- **Поддержка:** @art-mironoff
